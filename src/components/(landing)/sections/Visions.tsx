...
const Visions = () => {
	return (
		<div className="mx-auto bg-fixed py-24 md:p-16 flex md:flex-row flex-col gap-8 opacity-70 bg-[url('/images/games/1.jpg')]">
			<div className='md:flex-[7]' data-aos="fade-right">
			...
			<div className='md:flex-[4]' data-aos="fade-left">
				<Videos />
			</div>
		</div>
	);
